...
exports.parseFilters = json => {
  ...
  const filterWrapper = (wrapper.subMenu || wrapper.submenu).searchSubMenuRenderer.groups || []; // `|| []` added on. 
  // https://github.com/TimeForANinja/node-ytsr/issues/180#issuecomment-1507709961
